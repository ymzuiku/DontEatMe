...
#import "War_Class68.h"

@implementation War_Class68

-(void)createDate
{
    self.c_name = @"Level 68";
    self.c_scene = @"fruit";
    self.nextMusicTime = self.gap*28.2;
