...
#import "War_Class40.h"

@implementation War_Class40

-(void)createDate
{
    self.c_name = @"Level 40";
    self.c_scene = @"forest";
    self.nextMusicTime = self.gap*15.8;
    ...
    self.c_chickens = @[
                        ...
                        @{@"chickenType": @[ck(3, c_spoon, 0, nil),
                          ...
                          @"time": @(self.gap*6.5),},
                        //-------------------------- 8
                        @{@"chickenType": @[ck(0, c_shadow, 0, nil),
                                            ck(3, c_iron, 0, nil),
                                            ck(1, c_shadow, 0, nil),],
                          @"time": @(self.gap*7.5),},
                        ...
                        @{@"chickenType": @[ck(1, c_beer, 0, nil),
                                            ...
                                            ck(3, c_beer, 0, nil),
                                            ck(4, c_wooden, 0, nil),
                                            ck(0, c_shadow, 0, @"gold.1"),
                                            ck(1, c_shadow, 0, @"gold.1"),
                                            ck(2, c_saw, 0, nil),
                                            ck(3, c_shadow, 0, nil),
                                            ck(4, c_saw, 0, nil),
                                            ck(0, c_wooden, 0, nil),],
